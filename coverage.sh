...
grcov ./target/debug/deps -s . -t lcov --llvm --branch --ignore-not-existing --ignore "/*" --excl-br-start "mod tests \{" --excl-start "mod tests \{" --excl-line "#\[" --excl-br-line "#\[" -o lcov.info
